var map = new ol.Map({
  ...
  view: new ol.View({
    ...
    maxZoom: 18,
    minZoom: 1,
    center: [10658180.506436, 595450.189924], // Koordinat 5.339426°, 95.74074°
    zoom: 16,
  }),
});
...
//   .getView()
//   .fit(
//     [10572224.777305, 486914.425979, 10739811.369186, 658726.987092],
//     map.getSize()
//   );
...
var Title = new ol.control.Control({
  element: (() => {
    ...
    titleElement.innerHTML =
      '<h2 class="project-title">WebGIS Peta Hasil Verifikasi Tanam RKT 2025 Semester 1</h2>';
    return titleElement;
  })(),
    ...
    if (49 > 240) {
      ...
      window.showAbstract = function () {
        ...
        linkElement.innerHTML =
          "Hasil Verifikasi Tanam<br />Tanggal 1 - 31 Mei 2025";
      };
